...
class GeneralController extends GetxController{
  ...
  var imagePath = "".obs;
  //
  // _getFromGallery(BuildContext context , Permission platform) async {
  //   getitFromGallery(context, platform).then((value) async {
  //     if (value) {
  //       final pickedFile =
  ...
  //   getitFromCamera(context).then((value) async {
  //     if (value) {
  //       final pickedFile =
  ...
  //               onPressed: () {
  //                 Get.back();
  //                 _getFromGallery(context, platform);
  //               },
  //             ),
